...
output:function(){
	document.write('<div id="slashpage" style="position: absolute; z-index: 9999; color: white; background-color:white">') //Main splashpage container
